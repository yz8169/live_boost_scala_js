...
trait Tables {
  ...
  class Account(_tableTag: Tag) extends profile.api.Table[AccountRow](_tableTag, Some("live_boost"), "account") {
   ...
   *  @param sampleId Database column sample_id SqlType(LONGTEXT), Length(2147483647,true)
   *  @param unit Database column unit SqlType(LONGTEXT), Length(2147483647,true)
   *  @param address Database column address SqlType(LONGTEXT), Length(2147483647,true)
   *  @param name Database column name SqlType(LONGTEXT), Length(2147483647,true)
   *  @param sex Database column sex SqlType(LONGTEXT), Length(2147483647,true)
   *  @param office Database column office SqlType(LONGTEXT), Length(2147483647,true)
   *  @param doctor Database column doctor SqlType(LONGTEXT), Length(2147483647,true)
   *  @param number Database column number SqlType(LONGTEXT), Length(2147483647,true)
   *  @param sampleTime Database column sample_time SqlType(LONGTEXT), Length(2147483647,true)
   *  @param submitTime Database column submit_time SqlType(LONGTEXT), Length(2147483647,true)
   *  @param sampleType Database column sample_type SqlType(LONGTEXT), Length(2147483647,true)
   *  @param sampleStatus Database column sample_status SqlType(LONGTEXT), Length(2147483647,true)
   *  @param title Database column title SqlType(LONGTEXT), Length(2147483647,true)
   *  @param danger Database column danger SqlType(LONGTEXT), Length(2147483647,true)
   *  @param reporter Database column reporter SqlType(LONGTEXT), Length(2147483647,true)
   *  @param checker Database column checker SqlType(LONGTEXT), Length(2147483647,true)
   *  @param checkDate Database column check_date SqlType(LONGTEXT), Length(2147483647,true)
   *  @param reportDate Database column report_date SqlType(LONGTEXT), Length(2147483647,true) */
  ...
  class ExtraData(_tableTag: Tag) extends profile.api.Table[ExtraDataRow](_tableTag, Some("live_boost"), "extra_data") {
    ...
    /** Database column sample_id SqlType(LONGTEXT), Length(2147483647,true) */
    val sampleId: Rep[String] = column[String]("sample_id", O.Length(2147483647,varying=true))
    /** Database column unit SqlType(LONGTEXT), Length(2147483647,true) */
    val unit: Rep[String] = column[String]("unit", O.Length(2147483647,varying=true))
    /** Database column address SqlType(LONGTEXT), Length(2147483647,true) */
    val address: Rep[String] = column[String]("address", O.Length(2147483647,varying=true))
    /** Database column name SqlType(LONGTEXT), Length(2147483647,true) */
    val name: Rep[String] = column[String]("name", O.Length(2147483647,varying=true))
    /** Database column sex SqlType(LONGTEXT), Length(2147483647,true) */
    val sex: Rep[String] = column[String]("sex", O.Length(2147483647,varying=true))
    /** Database column office SqlType(LONGTEXT), Length(2147483647,true) */
    val office: Rep[String] = column[String]("office", O.Length(2147483647,varying=true))
    /** Database column doctor SqlType(LONGTEXT), Length(2147483647,true) */
    val doctor: Rep[String] = column[String]("doctor", O.Length(2147483647,varying=true))
    /** Database column number SqlType(LONGTEXT), Length(2147483647,true) */
    val number: Rep[String] = column[String]("number", O.Length(2147483647,varying=true))
    /** Database column sample_time SqlType(LONGTEXT), Length(2147483647,true) */
    val sampleTime: Rep[String] = column[String]("sample_time", O.Length(2147483647,varying=true))
    /** Database column submit_time SqlType(LONGTEXT), Length(2147483647,true) */
    val submitTime: Rep[String] = column[String]("submit_time", O.Length(2147483647,varying=true))
    /** Database column sample_type SqlType(LONGTEXT), Length(2147483647,true) */
    val sampleType: Rep[String] = column[String]("sample_type", O.Length(2147483647,varying=true))
    /** Database column sample_status SqlType(LONGTEXT), Length(2147483647,true) */
    val sampleStatus: Rep[String] = column[String]("sample_status", O.Length(2147483647,varying=true))
    ...
    /** Database column danger SqlType(LONGTEXT), Length(2147483647,true) */
    val danger: Rep[String] = column[String]("danger", O.Length(2147483647,varying=true))
    /** Database column reporter SqlType(LONGTEXT), Length(2147483647,true) */
    val reporter: Rep[String] = column[String]("reporter", O.Length(2147483647,varying=true))
    /** Database column checker SqlType(LONGTEXT), Length(2147483647,true) */
    val checker: Rep[String] = column[String]("checker", O.Length(2147483647,varying=true))
    /** Database column check_date SqlType(LONGTEXT), Length(2147483647,true) */
    val checkDate: Rep[String] = column[String]("check_date", O.Length(2147483647,varying=true))
    /** Database column report_date SqlType(LONGTEXT), Length(2147483647,true) */
    val reportDate: Rep[String] = column[String]("report_date", O.Length(2147483647,varying=true))
  }
  ...
  case class MissionRow(id: Int, userId: Int, sampleId: String, name: String, age: String, ast: String, alt: String, plt: String, score: String, result: String, endTime: DateTime)
  ...
  class Mission(_tableTag: Tag) extends profile.api.Table[MissionRow](_tableTag, Some("live_boost"), "mission") {
    def * = (id, userId, sampleId, name, age, ast, alt, plt, score, result, endTime) <> (MissionRow.tupled, MissionRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(userId), Rep.Some(sampleId), Rep.Some(name), Rep.Some(age), Rep.Some(ast), Rep.Some(alt), Rep.Some(plt), Rep.Some(score), Rep.Some(result), Rep.Some(endTime)).shaped.<>({r=>import r._; _1.map(_=> MissionRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class Mode(_tableTag: Tag) extends profile.api.Table[ModeRow](_tableTag, Some("live_boost"), "mode") {
  ...
  class PdfInfo(_tableTag: Tag) extends profile.api.Table[PdfInfoRow](_tableTag, Some("live_boost"), "pdf_info") {
  ...
  class Trash(_tableTag: Tag) extends profile.api.Table[TrashRow](_tableTag, Some("live_boost"), "trash") {
  ...
  class User(_tableTag: Tag) extends profile.api.Table[UserRow](_tableTag, Some("live_boost"), "user") {
